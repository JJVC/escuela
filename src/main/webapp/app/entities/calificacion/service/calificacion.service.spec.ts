...
import { CalificacionService, RestCalificacion } from './calificacion.service';

const requireRestSample: RestCalificacion = {
  ...sampleWithRequiredData,
  fechaRegistro: sampleWithRequiredData.fechaRegistro?.toJSON(),
};
