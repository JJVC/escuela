...
import { EntityArrayResponseType, CalificacionService } from '../service/calificacion.service';
...
export class CalificacionComponent implements OnInit {
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.calificacions = this.refineData(dataFromBody);
  }
  ...
  protected queryBackend(predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.calificacionService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
