...
import com.demo.escuela.repository.MateriaRepository;
...
class MateriaResourceIT {
    ...
    public static Materia createEntity(EntityManager em) {
        Materia materia = new Materia().nombre(DEFAULT_NOMBRE).activo(DEFAULT_ACTIVO);
        return materia;
    }
    ...
    public static Materia createUpdatedEntity(EntityManager em) {
        Materia materia = new Materia().nombre(UPDATED_NOMBRE).activo(UPDATED_ACTIVO);
        return materia;
    }
    ...
    void createMateria() throws Exception {
        ...
        assertThat(testMateria.getActivo()).isEqualTo(DEFAULT_ACTIVO);
    }
    ...
    void putExistingMateria() throws Exception {
        ...
        updatedMateria.nombre(UPDATED_NOMBRE).activo(UPDATED_ACTIVO);
        ...
        assertThat(testMateria.getActivo()).isEqualTo(UPDATED_ACTIVO);
    }
    ...
    void partialUpdateMateriaWithPatch() throws Exception {
        ...
        partialUpdatedMateria.nombre(UPDATED_NOMBRE).activo(UPDATED_ACTIVO);
